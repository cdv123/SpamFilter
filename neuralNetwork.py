...
# trainSentences2 = sentenceEmbedding(trainingData,spamData,embeddingDict,100)
# valSentences2 = sentenceEmbedding(valData,spamVal,embeddingDict,100)
...
# testSentences2 = sentenceEmbedding(testData,spamTest,embeddingDict,100)
...
# network2.train_network(20,trainSentences2,spamData,0.003,valSentences2,spamVal)
# # network.train_network(20,trainSentences,spamData,0.0004,9)
# print(network.test_network(testSentences,spamTest))
# print(network2.test_network(testSentences2,spamTest))
# plt.plot(range(20),network2.error, label = "Training Loss")
# plt.plot(range(20),network2.error_val, label = "Validation Loss")
# plt.legend()
# plt.show()