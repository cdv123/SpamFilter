...
# trainSentences = sentenceEmbedding2(trainingData,trainingSpamList,word2vec,500)
...
# valSentences = sentenceEmbedding2(valData,valSpamList,word2vec,500)
...
# testSentences = sentenceEmbedding2(testData,testSpamList,word2vec,500)
